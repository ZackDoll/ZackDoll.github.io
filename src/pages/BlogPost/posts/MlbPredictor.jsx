...
print(f'Model Accuracy: {accuracy * 100:.2f}%')  # 85.3%`}</code></pre>
      ...
      <ul>
        <li><a href="https://pitch-predictor.onrender.com" target="_blank" rel="noopener noreferrer">Try the live demo →</a></li>
        <li><a href="https://github.com/ZackDoll/PitchingStats" target="_blank" rel="noopener noreferrer">View the code on GitHub →</a></li>
        <li><a href="https://baseballsavant.mlb.com/" target="_blank" rel="noopener noreferrer">MLB StatCast database →</a></li>
      </ul>
    </>
  );
}
